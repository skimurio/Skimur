    ...
    public class PostWrapper : IPostWrapper
    {
        ...
        public List<PostWrapped> Wrap(List<Guid> postIds, User currentUser = null)
        {
            ...
            foreach (var item in posts)
            {
                ...
                {
                    // this user can approve/disapprove of a post, mark it as NSFW, etc.
                    item.CanManage = true;
                ...
                item.CanDelete = currentUser != null && (currentUser.IsAdmin || item.Post.UserId == currentUser.Id || item.CanManage);
            }
